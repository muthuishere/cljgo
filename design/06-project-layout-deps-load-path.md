...
**This doc decides nothing ADR 0048 has not already decided.** Where ADR 0048
...
loader that would have to be kept in sync by discipline (ADR 0048 §"already
de-risked").
...
Only **after** those land does `/opsx:propose` turn ADR 0048's decisions 1–6
