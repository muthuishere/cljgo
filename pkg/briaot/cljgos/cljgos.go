						...
						for {
							...
							if lang.IsTruthy(tmp79) {
								...
								_ = tmp84
								{
									...
									var vec__17690 any = tmp89
									_ = vec__17690
									tmp91 := v_clojure_DOT_core_nth.Get()
									tmp92 := lang.Apply3(tmp91, vec__17690, int64(0), nil)
									var X_93 any = tmp92
									_ = X_93
									tmp94 := v_clojure_DOT_core_nth.Get()
									tmp95 := lang.Apply3(tmp94, vec__17690, int64(1), nil)
						...
						for {
							...
							if lang.IsTruthy(tmp129) {
								...
								_ = tmp134
								{
									...
									var vec__176140 any = tmp139
									_ = vec__176140
									tmp141 := v_clojure_DOT_core_nth.Get()
									tmp142 := lang.Apply3(tmp141, vec__176140, int64(0), nil)
									var X_143 any = tmp142
									_ = X_143
									tmp144 := v_clojure_DOT_core_nth.Get()
									tmp145 := lang.Apply3(tmp144, vec__176140, int64(1), nil)
