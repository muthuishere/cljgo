	...
	tmp5 := lang.FnFunc(func(args ...any) any {
		...
		case 2:
			...
			_ = tmp12
			{
				...
				var map__19417 any = tmp16
				_ = map__19417
				tmp18 := v_clojure_DOT_core_seq_QMARK_.Get()
				tmp19 := lang.Apply1(tmp18, map__19417)
				var tmp20 any
				_ = tmp20
				if lang.IsTruthy(tmp19) {
					tmp21 := v_clojure_DOT_core_seq_to_map_for_destructuring.Get()
					tmp22 := lang.Apply1(tmp21, map__19417)
					tmp20 = tmp22
				} else {
					tmp20 = map__19417
				}
				var map__19423 any = tmp20
				_ = map__19423
				tmp24 := v_clojure_DOT_core_get.Get()
				tmp25 := lang.Apply2(tmp24, map__19423, kw_in)
				var in26 any = tmp25
				_ = in26
				tmp27 := v_clojure_DOT_core_get.Get()
				tmp28 := lang.Apply2(tmp27, map__19423, kw_out)
				var out29 any = tmp28
				_ = out29
				tmp30 := v_clojure_DOT_core_get.Get()
				tmp31 := lang.Apply2(tmp30, map__19423, kw_err)
				var err32 any = tmp31
				_ = err32
				tmp33 := v_clojure_DOT_core_get.Get()
				tmp34 := lang.Apply2(tmp33, map__19423, kw_X_handle)
