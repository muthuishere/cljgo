	...
	tmp5 := lang.FnFunc(func(args ...any) any {
		...
		case 2:
			...
			_ = tmp12
			{
				...
				var map__34717 any = tmp16
				_ = map__34717
				tmp18 := v_clojure_DOT_core_seq_QMARK_.Get()
				tmp19 := lang.Apply1(tmp18, map__34717)
				var tmp20 any
				_ = tmp20
				if lang.IsTruthy(tmp19) {
					tmp21 := v_clojure_DOT_core_seq_to_map_for_destructuring.Get()
					tmp22 := lang.Apply1(tmp21, map__34717)
					tmp20 = tmp22
				} else {
					tmp20 = map__34717
				}
				var map__34723 any = tmp20
				_ = map__34723
				tmp24 := v_clojure_DOT_core_get.Get()
				tmp25 := lang.Apply2(tmp24, map__34723, kw_in)
				var in26 any = tmp25
				_ = in26
				tmp27 := v_clojure_DOT_core_get.Get()
				tmp28 := lang.Apply2(tmp27, map__34723, kw_out)
				var out29 any = tmp28
				_ = out29
				tmp30 := v_clojure_DOT_core_get.Get()
				tmp31 := lang.Apply2(tmp30, map__34723, kw_err)
				var err32 any = tmp31
				_ = err32
				tmp33 := v_clojure_DOT_core_get.Get()
				tmp34 := lang.Apply2(tmp33, map__34723, kw_X_handle)
				...
				tmp44 := lang.NewMap(kw_in, in26, kw_out, out29, kw_err, err32, kw_wait, tmp39, kw_kill, tmp43)
				tmp12 = tmp44
			}
			return tmp12
		default:
