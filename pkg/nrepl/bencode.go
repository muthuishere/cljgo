// Bencode codec for nREPL's wire format (ADR 0031: own the codec —
// everything nREPL puts on the wire in ~150 lines, zero external deps).
// Adapted from spike S15 (spikes/s15-nrepl-minimal/bencode.go).
//
