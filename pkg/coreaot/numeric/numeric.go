...
func Load() {
	...
	v_clojure_DOT_core_random_sample.SetMeta(lang.NewMap(kw_file, "numeric.cljg", kw_line, int64(18), kw_column, int64(7), kw_end_line, int64(18), kw_end_column, int64(20), kw_arglists, lang.NewList(lang.NewVector(sym_prob), lang.NewVector(sym_prob, sym_coll))))
