...
func Load() {
	...
	v_clojure_DOT_string_escape.SetMeta(lang.NewMap(kw_file, "string.cljg", kw_line, int64(153), kw_column, int64(7), kw_end_line, int64(153), kw_end_column, int64(13), kw_doc, "Return a new string, using cmap to escape each character ch\n  from s as follows:\n\n  If (cmap ch) is nil, append ch to the new string.\n  If (cmap ch) is non-nil, append (str (cmap ch)) instead."))
