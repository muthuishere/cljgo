...
// equalKey compares map keys: keyword fast path, then Equiv — key
// lookup/dedup is Clojure `=` semantics (clojure.lang.
// PersistentArrayMap.equalKey uses Util.equiv).
// (cljgo M0: was Equals; fixed with the Equiv/Equals split.)
