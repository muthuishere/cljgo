...
// Equals is the Java AMapEntry (APersistentVector.equals) analog.
// (cljgo M0: added with the Equiv/Equals split.)
func (me *MapEntry) Equals(o any) bool {
	return apersistentVectorEquals(me, o)
}
