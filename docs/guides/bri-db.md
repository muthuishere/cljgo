...
`db/one!` throws `:cljg.data.cast/not-found`, which the bri.web.http error funnel maps
...
- `docs/guides/resource-generator.md` — scaffold a full CRUD slice over cljg.data.cast
- `docs/guides/bri-http.md` — the error funnel that turns `:cljg.data.cast/not-found` into 404
